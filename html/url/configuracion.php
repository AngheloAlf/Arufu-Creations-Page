						...
						<div id="collapseConfig" class="panel-collapse in">
							<div class="panel-body">
								<form action="" method="post">
									...
									<input type="checkbox" id="js" name="js" value="js" <?php if(!isset($_SESSION["togglejs"]) || (isset($_SESSION["togglejs"]) && !$_SESSION["togglejs"])){echo 'disabled=""';} if(isset($_SESSION["js"]) && $_SESSION["js"]){ echo 'checked=""';} ?> />
